...
import HandleSpamPage from '@/components/HandleSpamPage.vue'
...
router.beforeEach((to, from, next) => {
  const adminPath = ['/feedbackpage', '/controlluser','/cannedreply','/statpage','/handlesapmpage']; // 需要管理员权限的路径
