<template>
    <div class="h-full w-full bg-gray-50 flex flex-col">
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50" v-if="iscomplete">
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50" v-if="iserror">
            <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
                <div class=" text-lg text-center">反馈信息不能为空！</div>
                <hr>
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50" v-if="iserror">
            <div class="bg-white p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
                <div class=" text-lg text-center">上传失败！</div>
